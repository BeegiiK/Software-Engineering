...
public class veiwMap {
	...
	private TileCtrl B = TileCtrl.getInstance();
...
public String toString() { 
		...
		return ('\n'+
				...
				String.format("%" + (tabAmount + 02) + "s", "") + "\\" + "               " + A.spLabel(7) + A.getSpStr(7, 1) + "      "+B.getTlStr(1, 0)+"       "  + A.getSpStr(8, 1) + " " + A.spLabel(8) + "              " + "/" + '\n' +
				...
				String.format("%" + (tabAmount - 02) + "s", "") + A.spLabel(11) + " " + A.getSpStr(11, 1)+ "      "+B.getTlStr(1, 0)+"   " + A.spLabel(12) + " " + A.getSpStr(12, 1) + "                  " + A.getSpStr(13, 1) + " " + A.spLabel(13)+ "  "+B.getTlStr(1, 0)+"       " + A.getSpStr(14, 1) + " " + A.spLabel(14) + "       '...........'" + '\n' +
				...
				String.format("%" + (tabAmount - 02) + "s", "") + A.spLabel(16) + " " + A.getSpStr(16, 1) + "              " + A.spLabel(17) + " " + A.getSpStr(17, 1) + "      "+B.getTlStr(1, 0)+"       "  + A.getSpStr(18, 1) + " " + A.spLabel(18) + "              " + A.getSpStr(19, 1) + " " + A.spLabel(19) + "        _===========_" + '\n' +
				...
				String.format("%" + (tabAmount - 02) + "s", "") + A.spLabel(27) + " " + A.getSpStr(27, 1) + "              " + A.spLabel(28) + " " + A.getSpStr(28, 1) + "      "+B.getTlStr(1, 0)+"       "  + A.getSpStr(29, 1) + " " + A.spLabel(29) + "              " + A.getSpStr(30, 1) + " " + A.spLabel(30) + "      []|           |" + '\n' +
				...
				String.format("%" + (tabAmount + 02) + "s", "") + "\\" + "              " + A.spLabel(36) + " " + A.getSpStr(36, 1) + "      "+B.getTlStr(1, 0)+"       "  + A.getSpStr(37, 1) + " " + A.spLabel(37) + "              " + "/" + "            __|_________|" + '\n' +
