...
public String toString() { 
		...
		return ('\n'+
				...
				String.format("%" + (tabAmount + 04) + "s", "") + A.getLrStr(7, 1) + "     " + A.spLabel(9) + "    " + A.getLrStr(8, 1) + "       "+B.getTlStr(4, 3)+"          " + A.getLrStr(9, 1) + "    " + A.spLabel(10) + "     " + A.getLrStr(10, 1) + "           []|           |" + '\n' +
				...
				String.format("%" + (tabAmount + 00) + "s", "") + A.lrLabel(15) + " " + A.getLrStr(15,0) + A.getSpStr(20, 0) + A.getLrStr(16,0) + " " + A.lrLabel(16) + "    "+B.getTlStr(7, 2)+"     "  + A.lrLabel(17) + " " + A.getLrStr(17,0) + A.getSpStr(21, 0) +	A.getLrStr(18,0) + " " + A.lrLabel(18) + "        лл|           |" + '\n' +
				...
				String.format("%" + (tabAmount + 03) + "s", "") + A.getSpStr(27, 2) + "                " + A.getSpStr(28, 2) + "       "+B.getTlStr(10, 1)+"        " + A.getSpStr(29, 2) + "                " + A.getSpStr(30, 2) + "           []|           |" + '\n' +
				...
				String.format("%" + (tabAmount + 01) + "s", "") + "\\" + "       "+B.getTlStr(11, 4)+"         " + A.getSpStr(36, 0) + "                " + A.getSpStr(37, 0) +  "        "+B.getTlStr(12, 4)+"        " + "/" + "             |         |" + '\n' +
